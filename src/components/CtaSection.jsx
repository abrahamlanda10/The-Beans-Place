    ...
    return (
        <div className="cta-section">
            <ScrollReveal animation="fadeUp" delay={0}>
                <Badge variant="accet" className="mb-6">
                    Fresh Roast Daily
                </Badge>
            ...
            <ScrollReveal animation="fadeUp" delay={0.2}>
                <p className="cta-subtitle">
                    Skip the line. Order premium single-origin coffee online and get import PropTypes from 'prop-types'roasted to order. From our roastery to your doorstep in 1-2 business days.
                </p>
