    ...
    return(
        <div className="about-content">
            ...
            <Badge variant="default" className="mb-4">
                  Founded 2012 | Roasting in-house day one
            </Badge>
                
            </ScrollReveal>
            
            <ScrollReveal aniamtion="fadeUp" delay={0.1}>
                <h1>
                    <span className="muted">OUR STORY</span>
                </h1>
                
            </ScrollReveal>
            <ScrollReveal aniamtion="fadeIn" delay={0,2}>
            ...
            <div className="about-story-grid">
                <ScrollReveal animation="fadeLeft" className="about-story-text">
                    <p className="about-body lead--light">
                       ...
                       work directly wicoffee should be accessible to everyone- not just aficionados. We work directly with farming cooperatives across four .continents,paying above fair-trade prices to ensure quality from soil to
                       sip.
                  </p>

                  <p className="about-body  lead--light">
I                     Every week, our roastmaster cups dozens os samples to select only
                      the lots that meet our standard. whether you prefer a bright,
                      fruity Ethiopian yirgacheffe or a deep, chocolately Colombian 
                      Supremo, we roast each batch to order so it arrives at peak
                      freshness.
                    ...
                    <StaggerItem key={v.title} animation="fadeUp">
                        <Card glass className="about-value-card">
                            ...
                            <CardHeader>
                                ...
                                <h3 className="text-lg fony-bold text-(--cream)">{v.title}</h3>
